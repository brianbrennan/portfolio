...
<head>
	<meta charset="UTF-8">
	<title>Brian Brennan</title>
	<link rel="stylesheet" href="<?php echo $r; ?>/style.css">
	<link rel="stylesheet" href="<?php echo $r; ?>/libs/wow/animate.css">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	<script src="<?php echo $r; ?>/libs/wow/wow.min.js"></script>
	<script src="<?php echo $r; ?>/script.js"></script>
	...
	<header class="nav-down">
		<div class="wrapper">
			<div class="logo">
				...
				<g>
					<path  d="M12.7,0.8c0-0.4,0.4-0.8,1-0.8h19.1c0.6,0,0.9,0.4,0.9,0.8v11.4c0,0.4-0.3,0.8-0.9,0.8h-6.7v44.1h6.7
					...
					l12.1-6V0.8z"/>
					<path  d="M81.8,34.5c10.9,3.8,10.5,15.3,10.5,15.3c0,19.4-19.7,20.4-24.6,20.4H45.1c-0.5,0-0.9-0.4-0.9-0.8V0.8
					...
					<path  d="M125.4,41.8h-7.5v27.6c0,0.4-0.4,0.8-1,0.8h-11.4c-0.5,0-0.9-0.4-0.9-0.8V0.8c0-0.4,0.4-0.8,0.9-0.8h22.7
					...
					<path  d="M181.7,69.4c0,0.4-0.4,0.8-1,0.8h-19.1c-0.6,0-0.9-0.4-0.9-0.8V57.9c0-0.4,0.3-0.8,0.9-0.8h6.7V13h-6.7
